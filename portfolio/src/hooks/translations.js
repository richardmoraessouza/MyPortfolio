...
export const translations = {
  pt: {
    ...
    responses: {
      ...
      freelance: { id: 5, text: "Como freelancer, já desenvolvi diversos projetos Full Stack para clientes reais. Um destaque foi um site institucional para o setor de estética automotiva, entregue do zero ao deploy com foco em conversão: seção de serviços clara, galeria de antes/depois e formulário de agendamento direto via WhatsApp. O projeto alcançou 100/100 no Google Lighthouse em performance e SEO, aumentando significativamente a visibilidade orgânica e gerando um aumento real de clientes interessados em contratar o serviço de lavação e detalhamento. Esse é o padrão que busco em todos os meus projetos: soluções que não apenas existem, mas que geram impacto real e retorno comprovável para o negócio." },
    ...
    serginhoEstetiCar: {
      ...
      description:
        "Site institucional desenvolvido para cliente real do setor de estética automotiva. Entregue do zero ao deploy com foco em conversão: seção de serviços clara, galeria de antes/depois e formulário de agendamento direto via WhatsApp. Alcançou nota 100/100 no Google Lighthouse em performance e SEO, aumentando significativamente a visibilidade orgânica. Resultado direto: aumento de clientes interessados em contratar o serviço de lavação e detalhamento, gerando retorno real para o negócio."
    },
    calculator: {
      title: "Calculadora",
      description:
  ...
  en: {
    ...
    responses: {
      ...
      freelance: { id: 5, text: "As a freelancer, I have developed various Full Stack projects for real clients. One highlight was an institutional website for the automotive detailing industry, delivered end-to-end with a conversion focus: clear services section, before/after gallery and a direct WhatsApp booking form. The project achieved a perfect 100/100 on Google Lighthouse for performance and SEO, significantly boosting the business's organic visibility and generating a real increase in customers interested in contracting car wash and detailing services. This is the standard I pursue in all my projects: solutions that not only exist, but that generate real impact and proven return for the business." },
